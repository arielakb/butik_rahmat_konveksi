...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="#">BUTIK RAHMAT</a>
        ...
        <div class="container">
            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center"
                ...
                <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">BUTIK RAHMAT
                        <strong>KONVEKSI</strong>
                    </h1>
                    <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="#login"
                            data-toggle="modal" class="btn btn-primary px-5 py-3"><i class="fas fa-sign-in-alt">
                                Silahkan Login</i></a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="login" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true" style="zoom: 85%">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="password" type="password"
                                                    ...
                                                    placeholder="Masukan Password" id="pass">
