...
<head>
    ...
    <link rel="stylesheet"
        href="https://fonts.google.com/specimen/Cairo?selection.family=Cairo|Source+Sans+Pro:ital,wght@1,200">
    <!-- Font Awesome -->
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link mt-2">
                <center><span class="brand-text font-weight-light">Konveksi</span></center>
            </a>
            ...
            <div class="sidebar" style="zoom: 90%">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-header">PEMESANAN MASUK</li>
                        <li class="nav-item">
                        ...
                        <li class="nav-header">STOK BAHAN BAKU</li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-clipboard-list"></i>
                                <p>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/stok_bahan_baku" class="nav-link">
                                        <i class="fas fa-eye nav-icon"></i>
                                        <p>Lihat Stok</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/master_pegawai" class="nav-link">
                                        <p> PEGAWAI</p>
                                    </a>
                                </li>
                            </ul>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/master_supplier" class="nav-link">
                                        <p> SUPPLIER</p>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/master_stok_bahan_baku" class="nav-link">
                                        <p> STOK BAHAN BAKU</p>
                                    </a>
                                </li>
                            </ul>
        ...
        <div class="modal fade" id="modal_logout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('.BtnTambah').click(function() {
                var fieldHTML = '<div class="form-group col-md-12 kolom_asli">' + $(".kolom_copy").html() +
                    '</div>';
