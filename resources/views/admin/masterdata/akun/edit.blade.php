...
@section('konten')
                ...
                <form action="/master_akun/update/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="/print_akun/" class="btn btn-info btn-sm" style="border-radius: 15px"><i
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                                <input type="password" class="form-control" placeholder="Silahkan Di isi.." name="password"
                                    value="{{ $data->password }}">
                            </div>
                        </div>
                        <hr>
                        <hr>
                        <div class="form-group row">
                            <a href="#update_pw" data-toggle="modal" class="btn btn-sm btn-warning"><i class="fas fa-cogs">
                                    Ubah Password</i></a>
                        </div>
                        <hr>
    ...
    <!-- Modal -->
    <div class="modal fade" id="update_pw" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
