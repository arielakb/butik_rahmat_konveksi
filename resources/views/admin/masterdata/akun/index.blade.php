...
@section('konten')
            ...
            <div class="col-md-12">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="#tambah_akun" data-toggle="modal" class="btn btn-warning btn-sm" style="border-radius: 15px"><i
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/master_akun/edit/{{ $item->id }}" class="btn btn-info btn-sm"><i
                                                class="fas fa-edit"> Edit</i></a>
                                        <a href="/master_akun/hapus_akun/{{ $item->id }}"
    ...
    <!-- Modal -->
    <div class="modal fade" id="tambah_akun" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
