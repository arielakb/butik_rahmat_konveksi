            ...
            <div class="invoice p-3 mb-3">
                ...
                <div class="row invoice-info">
                    <div class="col-sm-4 invoice-col">
                        Hormat Kami,
                        <address>
                            <strong>BUTIK RAHMAT COLLECTION</strong><br>
                            Jl. Swadaya 1, Sawangan Lama, Kec. Sawangan, Kota Depok, Jawa Barat 16511<br>
                            Tlp.0821-2573-9476<br>
                            Fax : 021- 29081127<br>
                            Email: SidiqHusein@gmail.com
                        </address>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-4 invoice-col">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="lead"> Rincian Harga Pemesanan :
                            <b>{{ Carbon\carbon::parse($data->tgl_order)->format('d/M/Y') }}</b></p>
                ...
                <div class="row no-print">
                    <div class="col-12">
                        <button onclick="window.print()"rel="noopener" target="_blank" class="btn btn-info btn-xl"><i
