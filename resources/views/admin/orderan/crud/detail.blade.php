        ...
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-header bg-info">
                    <h3 class="card-title">FORM DETAIL PESANAN</h3>
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <h4 class="text-center">Detail Pelanggan</h4>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control text-center" value="{{ $data->no_po }}"
                                        name="no_po" disabled>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ $data->nama_vendor }}"
                                        name="nama_vendor" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">NO.HP</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ $data->no_hp }}" id="no_hp"
                                        disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group row mt-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ $data->pesanan_untuk }}"
                                        id="pesanan_untuk" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                @if ($data->dp == null)
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control bg-warning" value="Tidak Ada DP"
                                            id="jumlah_dp" disabled>
                                    @else
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control bg-warning"
                                                value="{{ number_format($data->dp, 2, '.', ',') }}" id="jumlah_dp" disabled>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control bg-danger"
                                value="{{ Carbon\carbon::parse($data->deadline)->format('d-M-Y') }}" id="dealine"
                                disabled>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            @if ($hitung_data == 2)
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="text-center bg-dark">Jenis Pesanan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" id="catatan1">
                                            ...
                                            <input type="text" class="form-control" placeholder="Masukan Catatan.."
                                                name="catatan[]" value="{{ $catatan[0] }}" readonly>
                                        </div>
                                    </div>
                                </div>
                        </div>
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Rp. {{ number_format($total_vendor1, 2, '.' . '.') }}
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th scope="col">Profit Value</th>
                                                    <input type="text" hidden value="{{ $profit_value1 }}">
                                                    <th scope="col">Rp. {{ number_format($profit_value1, 2, '.' . '.') }}
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th scope="col" class="text-center bg-success">
                                                        <h3> SUBTOTAL PROFIT</h3>
                                                    </th>
                                                    <th scope="col" class="bg-success"><strong>
                                                            <h4>Rp. {{ number_format($total_profit1, 2, '.' . '.') }}
                                                        </strong></h4>
                                                    </th>
                                            ...
                                            @if ($hitung_data == 3)
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <th class="text-center bg-dark" colspan="7">Detail Pemesanan</th>
                                                        <tr>
                                                            <th class="text-center bg-info">No.</th>
                                                            <th class="text-center bg-info">Jenis Pesanan</th>
                                                ...
                                                <div class="col-md-12">
                                                    <table class="table table-hover">
                                                        <thead>
                                                                ...
                                                                <th scope="col">Total Pemesanan</th>
                                                                <th scope="col">Rp.
                                                                    {{ number_format($total_vendor2, 2, '.' . '.') }}</th>
                                                            </tr>
                                                            <tr>
                                                                <th scope="col">Profit Value</th>
                                                                <th scope="col">Rp.
                                                                    {{ number_format($profit_value2, 2, '.' . '.') }}</th>
                                                            </tr>
                                                            <tr>
                                                                <th scope="col" class="text-center bg-success">
                                                                    <h3> SUBTOTAL PROFIT</h3>
                                                        ...
                                                        @if ($hitung_data == 4)
                                                            <table class="table table-bordered">
                                                                <thead>
                                                                    <th class="text-center bg-dark" colspan="7">Detail
                                                                        Pesanan</th>
                                                                    <tr>
                                                                        <th class="text-center bg-info">No.</th>
                                                                        <th class="text-center bg-info">Jenis Pesanan</th>
                                                                        ...
                                                                        <table class="table table-bordered">
                                                                            <thead>
                                                                                <th class="text-center bg-dark"
                                                                                    colspan="7">Detail Pemesanan</th>
                                                                                <tr>
                                                                                    <th class="text-center bg-info">No.
                                                                                    </th>
                                                                                    <th class="text-center bg-info">Jenis
                                                                                        Pemesanan</th>
                                                                                    <th class="text-center bg-info">QTY
                                                                                    </th>
                                                                                    <th class="text-center bg-info">Harga
                                                                                        Satuan</th>
                                                                                    <th class="text-center bg-info">Bahan
                                                                                    </th>
                                                                                    <th class="text-center bg-info">Warna
                                                                                    </th>
                                                                                    <th class="text-center bg-info">Catatan
                                                                                    </th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <table class="table table-hover">
                                                                                <thead>
                                                                                    ...
                                                                                    <tr>
                                                                                        <th scope="col">Profit Value
                                                                                        </th>
                                                                                        <th scope="col">Rp.
                                                                                            {{ number_format($profit_value4, 2, '.' . '.') }}
                                                                                        </th>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th scope="col"
                                                                                        ...
                                                                                        <th scope="col"
                                                                                            class="bg-success"><strong>
                                                                                                <h4>Rp.
                                                                                                    {{ number_format($total_profit4, 2, '.' . '.') }}
                                                                                            </strong></h4>
                                                                                        </th>
                                                                                    </tr>
                                                                                </thead>
                                                                                                                                                        ...
                                                                                                                                                        <thead>
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                ...
                                                                                                                                                                <th
                                                                                                                                                                    scope="col">
                                                                                                                                                                    Rp.
                                                                                                                                                                    {{ number_format($profit_value10, 2, '.' . '.') }}
                                                                                                                                                                </th>
                                                                                                                                                            </tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <th scope="col"
                                                                                                                                                                ...
                                                                                                                                                                <th scope="col"
                                                                                                                                                                    ...
                                                                                                                                                                    <strong>
                                                                                                                                                                        <h4>Rp.
                                                                                                                                                                            {{ number_format($total_profit10, 2, '.' . '.') }}
                                                                                                                                                                    </strong>
                                                                                                                                                                    </h4>
                                                                                                                                                                </th>
                                                                                                                                                            </tr>
