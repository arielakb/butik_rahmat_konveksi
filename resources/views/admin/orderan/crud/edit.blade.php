    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-default">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" placeholder="Silahkan Di isi.."
                                            name="tanggal" value="{{ $data->tgl_order }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Silahkan Di isi.."
                                            name="nama_vendor" value="{{ $data->nama_vendor }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Silahkan Di isi.."
                                            name="pesanan_untuk" value="{{ $data->pesanan_untuk }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            @if ($data->dp != null)
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control" value="{{ $data->dp }}"
                                                        id="jumlah_dp" name="dp">
                                                @else
                                                    <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Status Pesanan</label>
                                <div class="col-sm-10">
                ...
                <hr>
                <div class="col-md-12">
                    <h4 class="text-center"><b>Detail Pesanan</b></h4>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Masukan Detail Orderan.."
                                            name="jenis_orderan[]" value="{{ $jenis_orderan[0] }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Bahan</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Masukan Detail Bahan.."
                                            name="bahan[]" value="{{ $bahan[0] }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Warna</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Masukan Detail Warna.."
                                            name="warna[]" value="{{ $warna[0] }}">
                                    </div>
                                </div>
                                <div div class="form-group row" id="harga">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" placeholder="Masukan Harga.."
                                            name="harga_satuan[]" value="{{ $harga_satuan[0] }}">
                                    </div>
                                </div>
                                <div class="form-group row" id="qty1">
                                    <label for="" class="col-sm-2 col-form-label">QTY</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="Satuan Pcs.."
                                            name="qty[]" value="{{ $qty[0] }}">
                                    </div>
                                    <h4>Pcs</h4>
                                </div>
                        ...
                        <div class="row">
                            @for ($x = 0; $x < count($jenis_orderan); $x++)
                                @if (!empty($jenis_orderan[$x]))
                                    <div class="col-md-6">
                                        <h4 class="text-center"><span class="badge badge-pill badge-warning">Item
                                                {{ $jenis_orderan[$x] }} </span></h4>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Pesanan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control"
                                                    placeholder="Masukan Detail Orderan.." name="jenis_orderan[]"
                                                    value="{{ $jenis_orderan[$x] }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Bahan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control"
                                                    placeholder="Masukan Detail Bahan.." name="bahan[]"
                                                    value="{{ $bahan[$x] }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control"
                                                    placeholder="Masukan Detail Warna.." name="warna[]"
                                                    value="{{ $warna[$x] }}">
                                            </div>
                                        </div>
                                        <div div class="form-group row" id="harga">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" placeholder="Masukan Harga.."
                                                    name="harga_satuan[]" value="{{ $harga_satuan[$x] }}">
                                            </div>
                                        </div>
                                        <div class="form-group row" id="qty1">
                                            <label for="" class="col-sm-2 col-form-label">QTY</label>
                ...
                <div class="kolom_copy" style="display: none">
                    <div class="col-md-12">
                        <h4 class="text-center"><b>Form Tambah Pesanan</b></h4>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-1 col-form-label">Jenis Pesanan</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Masukan Detail Orderan.."
                                    name="jenis_orderan[]">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <button type="submit" class="btn btn-success btn-block btn-xl" style="border-radius: 15px"><i
                                class="fa fa-save"> Update Pesanan</i></button>
                    </div>
                </div>
                </form>
            </div>
