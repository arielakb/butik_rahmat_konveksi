        ...
        <div class="col-md-12">
            <div class="card card-default">
                <div class="card-header bg-info">
                    <h3 class="card-title">FORM INPUT PESANAN</h3>
                ...
                <div class="card-body">
                    <form action="/input_orderan" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        @if ($po_terakhir != null)
                                            <input type="text" class="form-control" value="{{ $po_terakhir->no_po }}"
                                                disabled>
                                        @else
                                            Belum Ada
                                        @endif
                                ...
                                <div class="form-group row" id="total_dp">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" placeholder="Masukan Nominal DP.."
                                            name="dp">
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="kolom_asli">
                            ...
                            <a href="javascript:void(0)" class="btn btn-info btn-xl BtnTambah"><i class="fa fa-plus">
                                    Tambah</a></i>
                            <hr>
                        </div>
                        ...
                        <div class="kolom_copy" style="display: none">
                            ...
                            <a href="javascript:void(0)" class="btn btn-danger btn-xl" id="BtnHapus"><i
                                    class="fa fa-trash"> Hapus</a></i>
                            <hr>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-success btn-block btn-xl"><i
                                        class="fa fa-calculator"> Hitung Orderan</i></button>
                            </div>
                        </div>
                    </form>
                </div>
