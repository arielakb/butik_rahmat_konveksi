        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="far fa-clipboard"> DAFTAR PESANAN ON PROSES</i></h3>
                </div>
                <!-- ./card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr data-widget="expandable-table" aria-expanded="false">
                                    ...
                                    <td class="text-center"><span class="badge badge-warning">Proses Produksi</td>
                                    <td class="text-center">
                                        <a href="/lihat_orderan/detail/{{ $item->id }}"
                                            class="btn btn-warning btn-sm"><i class="fas fa-eye"> Detail</i></a>
                                        <a href="/orderan/selesai_produksi/{{ $item->id }}"
                                            class="btn btn-outline-info btn-sm "><i class="fas fa-clipboard-check"> Selesai
                                                Produksi</i></a>
                                    </td>
                                </tr>
