...
@section('konten')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">LIST DAFTAR STOK BARANG <span
                    class="badge badge-warning"><b>{{ $join[0]->nama_loker }}</span></b></h3>
            <div class="card-tools">
                ...
                <a href="/print_stok/{{ $join[0]->nama_loker }}" class="btn btn-info btn-sm" style="border-radius: 15px"><i
