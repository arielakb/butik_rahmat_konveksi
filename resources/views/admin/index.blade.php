    ...
    <div class="row">
        <div class="col-md-2 col-6">
            <div class="small-box bg-dark">
                <div class="inner">
                    ...
                    $stokbahanbaku = StokBahanBakuModel::select('nama_loker_bahan')->count();
        ...
        <div class="col-md-2 col-6">
            <div class="small-box bg-danger">
                ...
                <a href="/orderan/belum_proses" class="small-box-footer">Lihat Data <i
        ...
        <div class="col-md-2 col-6">
            <div class="small-box bg-secondary">
                ...
                <a href="/master_stok_bahan_baku" class="small-box-footer">Lihat Data <i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
