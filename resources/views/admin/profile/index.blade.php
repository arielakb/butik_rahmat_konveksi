...
@section('konten')
            ...
            <div class="card card-primary">
                ...
                <div class="card card-primary">
                    <div class="card-body box-profile">
                        ...
                        <a href="#modal_edit" data-toggle="modal" class="btn btn-primary btn-block"><i
                                class="far fa-edit"><b> Edit Akun</i></b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <a href="#ubah_pw" data-toggle="modal" class="btn btn-warning btn-sm"><i
                                                class="fas fa-cogs"> Ubah Password</i></a>
                                    </div>
                                </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="ubah_pw" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-md">
                ...
                <form action="/update_profile/update_pw/{{ Auth::user()->id }}" method="POST"
