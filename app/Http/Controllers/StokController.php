...
class StokController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('tbl_stok.id','tbl_loker.id_loker', 'tbl_stok.nama_loker', 'tbl_stok.nama_barang', 'tbl_stok.warna', 'tbl_stok.bahan', 'tbl_stok.size', 'tbl_stok.qty', 'tbl_stok.tgl_pemeriksaan', 'tbl_stok.pemeriksa')
        ->get();
        // dd($join[0]->id_loker);
    ...
    public function show($id)
    {
        ...
        $join = DB::table('tbl_stok')
        ->join('tbl_loker', 'tbl_loker.nama_loker', '=', 'tbl_stok.nama_loker')
        ->select('tbl_stok.id', 'tbl_stok.nama_loker','tbl_stok.nama_barang', 'tbl_stok.warna', 'tbl_stok.bahan', 'tbl_stok.size', 'tbl_stok.qty', 'tbl_stok.tgl_pemeriksaan', 'tbl_stok.pemeriksa')
