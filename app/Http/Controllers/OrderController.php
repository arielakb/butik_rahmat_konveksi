...
class OrderController extends Controller
{
    ...
    public function on_proses()
    {
        ...
        return view('admin.orderan.status.onproses', compact('data'));
    }
    ...
    public function show($id)
    {
        ...
        if ($hitung_data == 2) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'jumlah1', 'hitung_data', 'total_vendor1', 'total_hpp', 'subtotal_vendor_hpp1', 'omset_hpp1', 'profit_value1', 'total_profit1', 'catatan', 'bahan', 'warna'));
        }
        ...
        elseif ($hitung_data == 3) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor2', 'total_hpp', 'subtotal_vendor_hpp2', 'omset_hpp2', 'profit_value2', 'total_profit2', 'catatan', 'bahan', 'warna',));
        }
        ...
        elseif ($hitung_data == 4) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor3', 'total_hpp', 'subtotal_vendor_hpp3', 'omset_hpp3', 'profit_value3', 'total_profit3', 'catatan', 'bahan', 'warna',));
        }
        ...
        elseif ($hitung_data == 5) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor4', 'total_hpp', 'subtotal_vendor_hpp4', 'omset_hpp4', 'profit_value4', 'total_profit4', 'catatan', 'bahan', 'warna'));
        }
        ...
        elseif ($hitung_data == 6) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor5', 'total_hpp', 'subtotal_vendor_hpp5', 'omset_hpp5', 'profit_value5', 'total_profit5', 'catatan', 'bahan', 'warna'));
        }
        ...
        elseif ($hitung_data == 7) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor6', 'total_hpp', 'subtotal_vendor_hpp6', 'omset_hpp6', 'profit_value6', 'total_profit6', 'catatan', 'bahan', 'warna'));
        }
        ...
        elseif ($hitung_data == 8) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor7', 'total_hpp', 'subtotal_vendor_hpp7', 'omset_hpp7', 'profit_value7', 'total_profit7', 'catatan', 'bahan', 'warna'));
        }
        ...
        elseif ($hitung_data == 9) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor8', 'total_hpp', 'subtotal_vendor_hpp8', 'omset_hpp8', 'profit_value8', 'total_profit8', 'catatan', 'bahan', 'warna'));
        }
        ...
        elseif ($hitung_data == 10) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor9', 'total_hpp', 'subtotal_vendor_hpp9', 'omset_hpp9', 'profit_value9', 'total_profit9', 'catatan', 'bahan', 'warna'));
        }
        ...
        elseif ($hitung_data == 11) {
            ...
            return view('admin.orderan.crud.detail', compact('data', 'jenis_orderan', 'qty', 'harga_satuan', 'hitung_data', 'total_vendor10', 'total_hpp', 'subtotal_vendor_hpp10', 'omset_hpp10', 'profit_value10', 'total_profit10', 'catatan', 'bahan', 'warna'));
        }
    }
